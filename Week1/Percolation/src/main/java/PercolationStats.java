...
public class PercolationStats {
	...
	System.out.println(String.format("95 percent confidence interval\t = [%s, %s]", stats.confidenceLo(), stats.confidenceHi()));}
    ...
    public void openSite (Percolation p, TreeSet<Integer> openSites) {
